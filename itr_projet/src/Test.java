...
public class Test {
	...
	public static void main(String[] args) {
		...
		Manager fh = new Manager("Hollande","Fran�ois",true, 1939,342,gouv);
		...
		try {
			System.out.println("Pourcentage de femmes sous la responsabilit� de DD : "+dd.pourcentageFemmes());
			System.out.println("Pourcentage de femmes sous la responsabilit� de FH : "+fh.pourcentageFemmes());
			System.out.println("Pourcentage de femmes sous la responsabilit� de DB : "+db.pourcentageFemmes());
		}
		...
		try {
			...
			System.out.println(a.chercher("Gouvernement Fran�ais"));
			System.out.println(a.chercher("Dagot"));
			System.out.println(a.chercher("Yin"));
		}
		catch (NoContactInfoException e) {
			System.out.println("Une recherche a �chou� : "+e.getMessage());
		}
	}
